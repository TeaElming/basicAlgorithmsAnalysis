...
public class ComparingUnionsArrayGraph {
  ...
  public static void main(String[] args) {
    ...
    XYSeriesCollection varyingSizesDataset = generateUnionTimeWithVaryingSizesDataset(sizes, unions);


    createAndShowScatterPlot(varyingSizesDataset, "Execution Time of 99 Unions vs. Array Size", "Array Size");
  }
