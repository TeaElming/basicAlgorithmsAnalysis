...
public class ComparingFindsFindsGraph {
  ...
  public static void main(String[] args) {
    // Test with varying number of finds
    int size = 10000;
    ...
    XYSeriesCollection varyingSizesDataset = generateFindTimeDataset(size, numberOfFinds);

    createAndShowScatterPlot(varyingSizesDataset, "Execution Time vs. Number of Finds executed (size: 10,000)", "Number of Finds");
  }
